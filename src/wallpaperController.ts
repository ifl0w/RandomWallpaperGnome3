...
class WallpaperController {
    ...
    async fetchNewWallpaper(): Promise<void> {
        ...
        try {
            ...
            Logger.info(`Requesting ${fetchPromises.length} new images. ${this.constructor.name}`, this);
            ...
            Logger.debug(`Fetched ${newImageEntries.length} new images. ${this.constructor.name}`, this);
            ...
            if (newWallpaperPaths.length < monitorCount)
                Logger.warn(`Unable to fill all displays with new images. ${this.constructor.name}`, this);
