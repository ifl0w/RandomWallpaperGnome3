...
// Manually extended with Adw.EntryRow which is somehow missing form the original file
...
export class EntryRow extends PreferencesRow implements Gtk.Accessible, Gtk.Actionable, Gtk.Buildable, Gtk.Editable, Gtk.ConstraintTarget {
